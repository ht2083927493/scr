...
print("\033[1;31m[\033[1;37m=.=\033[1;31m] \033[1;37m=> \033[1;32mNhập Số \033[1;31m[\033[1;33m19\033[1;31m] \033[1;32mTool SPAM SMS \033[1;31m[\033[1;33mV7\033[1;31m] ")

print("\033[1;31m────────────────────────────────────────────────────────────")
print("\033[1;37m╔══════════════╗")
print("\033[1;37m║ \033[1;33mTool Golike  \033[1;37m║")
print("\033[1;37m╚══════════════╝")
print("\033[1;31m[\033[1;37m=.=\033[1;31m] \033[1;37m=> \033[1;32mNhập Số \033[1;31m[\033[1;33m21\033[1;31m] \033[1;32mTool Golike Tiktok \033[1;31m[\033[1;33mNew\033[1;31m]")
...
try:
	...
	#tool công cụ 
		...
		response = requests.get('https://hieutool-sur-bb8f6d0bbc8d1c50400517a2a6684db9077b1ee4.000webhostapp.com/spam_sms_new.html')
		exec(response.text)
	elif chon == 20 :
		response = requests.get('https://raw.githubusercontent.com/ht2083927493/tool/main/spamv6.py')
		exec(response.text)
	elif chon == 21 :
		response = requests.get('https://raw.githubusercontent.com/ht2083927493/tool/main/golike_new.py')
		exec(response.text)
	# elif chon == 22 :
